  ...
  <div class="send-and-pay">
    ...
    <div class="returned-info-top">
      ...
      <div class="returned-info-top-item common2">
        <p class="c4 ft14 fw600">融资放款日期</p>
        <p class="c8 ft20 fw600">{{ sendAndPayInfo.loanDate || '-' }}</p>
      </div>
      <div class="returned-info-top-item">
        <p class="c4 ft14 fw600" style="margin: 0">融资到期日期</p>
        <p class="c8 ft20 fw600">{{ sendAndPayInfo.endDate || '-' }}</p>
      </div>
    </div>
    <div class="slTitleAssis" style="margin-bottom: 20px" v-if="sendAndPayInfo.assetBillVO">融单信息</div>
    <div class="returned-info-top" v-if="sendAndPayInfo.assetBillVO">
      <div class="returned-info-top-item">
        <p class="c4 ft14 fw600">融单编号</p>
        <p class="c8 ft20 fw600">{{ sendAndPayInfo.assetBillVO.bankBillNo || '-' }}</p>
      </div>
      <div class="returned-info-top-item common">
        <p class="c4 ft14 fw600">开立方</p>
        <p class="c8 ft20 fw600">{{ sendAndPayInfo.assetBillVO.issuerName || '-' }}</p>
      </div>
      <div class="returned-info-top-item common2">
        <p class="c4 ft14 fw600">开立日期</p>
        <p class="c8 ft20 fw600">{{ sendAndPayInfo.assetBillVO.issueDate || '-' }}</p>
      </div>
      <div class="returned-info-top-item">
        <p class="c4 ft14 fw600">贴现日期</p>
        <p class="c8 ft20 fw600">{{ sendAndPayInfo.assetBillVO.discountedDate || '-' }}</p>
      </div>
      <div class="returned-info-top-item common">
        <p class="c4 ft14 fw600">融单金额</p>
        <p class="c8 ft20 fw600" v-if="sendAndPayInfo.assetBillVO.billAmount">
          ￥{{ formatMoney(sendAndPayInfo.assetBillVO.billAmount) }}
        </p>
        <p class="c8 ft20 fw600" v-else>-</p>
      </div>
      <div class="returned-info-top-item common2">
        <p class="c4 ft14 fw600">接收方</p>
        <p class="c8 ft20 fw600">{{ sendAndPayInfo.assetBillVO.receiverName || '-' }}</p>
      </div>
      <div class="returned-info-top-item">
        <p class="c4 ft14 fw600">承诺付款日</p>
        <p class="c8 ft20 fw600">{{ sendAndPayInfo.assetBillVO.acceptanceDate || '-' }}</p>
      </div>
    </div>
    <div class="slTitleAssis" style="margin-bottom: 20px">还款信息</div>
    <div class="returned-info-top">
      <div class="returned-info-top-item">
        <p class="c4 ft14 fw600">到期合计金额</p>
        <p class="c8 ft20 fw600" v-if="sendAndPayInfo.dueTotalAmount">
          ￥{{ formatMoney(sendAndPayInfo.dueTotalAmount) }}
        </p>
        <p class="c8 ft20 fw600" v-else>-</p>
      </div>
      <div class="returned-info-top-item common">
        <p class="c4 ft14 fw600">未还款合计</p>
        <p class="c8 ft20 fw600" v-if="sendAndPayInfo.unPayAmount">￥{{ formatMoney(sendAndPayInfo.unPayAmount) }}</p>
        <p class="c8 ft20 fw600" v-else>-</p>
      </div>
      <div class="returned-info-top-item common2">
        <p class="c4 ft14 fw600">已还款合计</p>
