<template>
  <div>
      ...
      <a-col flex="1">
        <div class="titleInfoBox" >
          <div class="titleInfoTitle">
            <a-space :size="12">
              <em class="contractTypeSymbol" style="background: var(--primary-color)">融</em>
              <div @mouseenter="copyVisible = true"  @mouseleave="copyVisible = false" >

                <span class="cur" style="margin-right:10px">融资编号：{{detailData.serialNo}}</span>
              ...
              <FinancingTipInfo v-else  :item="detailData" :API_GetFinancingStatusTip='API_GetFinancingStatusTip'></FinancingTipInfo>
            </a-space>
          </div>
        </div>
      </a-col>
    ...
    <a-row class="supple-info">
      ...
      <div class="titleInfoItem">
        <span class="label" style="width:80px">出资机构：</span>
        <span class="omit"  >
          <a-tooltip>
            <template slot="title">
              {{detailData.bankName}}
      ...
      <div class="titleInfoItem">
        <span class="label"  style="width:130px">融资申请创建时间：</span>
