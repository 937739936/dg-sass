<template>
	<div class="contentBox">
		<div
			...
			v-if="otherInfo"
		>
			<p class="title">{{ pageTypeText }}单据</p>
			...
			<template v-if="editFlag">
				...
				>
					...
					>
						<a @click="preview(items.path)">查看</a>
						<!-- <a-popconfirm
...
export default {
	...
	data() {
		return {
			...
			previewImg: '',
			filesColumns: [
				{ title: '凭证类型', dataIndex: 'type', scopedSlots: { customRender: 'type' } },
				{ title: '初始文件名', dataIndex: 'originalFileName', scopedSlots: { customRender: 'name' } },
	...
	props: ['editFlag', 'otherInfo', 'noFileName', 'receivalVO', 'pageTypeText'],
	components: {
		Upload
	},
	watch: {
