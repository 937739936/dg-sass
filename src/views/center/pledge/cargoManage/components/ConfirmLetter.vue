<template>
    <div class="contentBox">
        <div class="content" v-if="confirmLetterInfo">
            <p class="title">确认函信息</p>
            <p class="sub-title">附件信息</p>
            <a-table :pagination="false" :columns="noFileName ? noFileNameFilesColumns:filesColumns" :data-source="confirmLetterInfo.list"  :scroll="{x:true}" rowKey="index">
