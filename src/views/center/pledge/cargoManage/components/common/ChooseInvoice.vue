<template>
    <a-modal v-model="visible" width="1000px" @ok="okInc" title="选择发票">
                    ...
                    >
                        ...
                        <a-col :span="12" class="row">
                            ...
                            <a-form-item label=" " :colon="false">
                                <a-button type="primary" @click.native="getList"
                                    >查询</a-button
                                >
                                <a-button
...
<script>
import { API_GetReceivableInvoListLine, API_ExportInvoice } from "api";
export default {
    name: "ChooseInvoice",
