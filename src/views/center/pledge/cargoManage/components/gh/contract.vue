    ...
    <div class="contentBox" v-if="contractInfo">
                    ...
                    <a-row>
                        ...
                        <a-col :span="12">
                            <a-row :gutter="20">
                                ...
                                <a-col :span="16"><span class="red">{{contractInfo.upContract.amount}}</span>&nbsp;元</a-col>
                            </a-row>
                        </a-col>
                        <a-col :span="12">
                            <a-row :gutter="20">
                        ...
                        <!-- 双签状态 -->
                        <a-col :span="12" v-if="contractInfo.upContract.signStatus == '2'">
                            <a-row :gutter="20">
        ...
        <div class="downstreamBox">
            ...
            <div class="content">
                <div>
                    ...
                    <a-row>
                        ...
                        <a-col :span="12">
                            <a-row :gutter="20">
                                <a-col :span="8">合同金额</a-col>
                                <a-col :span="16"><span class="red">{{contractInfo.downOnlineContract.amount}}</span>&nbsp;元</a-col>
                            </a-row>
                        </a-col>
                        <a-col :span="12">
                            <a-row :gutter="20">
                        ...
                        <a-col :span="12">
                            <a-row :gutter="20">
                                <a-col :span="8">到期日期</a-col>
                                <a-col :span="16">{{contractInfo.downOnlineContract.endDate}}</a-col>
                            </a-row>
                        </a-col>
                        <a-col :span="12">
                            <a-row :gutter="20">
                                <a-col :span="6">签订状态</a-col>
                                <a-col :span="18" class="doubleSign" v-if="contractInfo.downOnlineContract.signStatus=='2'">双签</a-col>
                                <a-col :span="18" class="singleSign" v-if="contractInfo.downOnlineContract.signStatus=='1'">单签</a-col>
                            </a-row>
                        </a-col>
                        <!-- 双签状态 -->
                        <a-col :span="12" v-if="contractInfo.downOnlineContract.signStatus == '2'">
                            <a-row :gutter="20">
                                <a-col :span="8">双签版合同获得日期</a-col>
                ...
                <div>
                    <p class="sub-title">合同详情</p>
                    <a-table :pagination="false" :columns="contractDetailColumns" :data-source="downstreamContractDetailData"  :scroll="{x:true}" rowKey="id"></a-table>
                </div>
                ...
                <div>
                    ...
                    <template v-if="editFlag">
                        ...
                        <Upload :receivalVO="receivalVO" @uploadFiles="getUploadFiles" type="CONTRACT_OTHER_BID_PROOF" btnText="上传中标佐证"></Upload>
                        <span style="font-family: PingFangSC-Regular;font-size: 12px;color: #C8CCD5;">单个文件最大支持100M，支持多个上传</span>
                        <a-table v-if="contractInfo.downOnlineContract" :pagination="false" :columns="editFilesColumns" :data-source="editDownContractList"  :scroll="{x:true}" rowKey="path">
                            <template slot="type" slot-scope="type">
                                {{CONSTANTS.fileType[type]}}
                            </template>
                            <template slot="name" slot-scope="name,items">
                    ...
                    <!-- 上游附件信息详情模块 -->
                    <a-table v-if="contractInfo.downOnlineContract && !editFlag" :pagination="false" :columns="noFileName ? noFileNameFilesColumns:filesColumns" :data-source="contractInfo.downOnlineContract.list"  :scroll="{x:true}" rowKey="path">
                        <template slot="type" slot-scope="type">
                            {{CONSTANTS.fileType[type]}}
                        </template>
                        <template slot="name" slot-scope="name,items">
        ...
        <div class="tradeBox">
            ...
            <div class="content" style="padding-bottom: 0;">
                <div>
                    ...
                    <!-- 贸易背景合同编辑模块 -->
                    <template v-if="editFlag">
                        <Upload :receivalVO="receivalVO" @uploadFiles="getUploadFiles" type="ASSET_TRADE_BACKGROUND_CONTRACT" btnText="上传贸易背景合同"></Upload>
                        <span style="font-family: PingFangSC-Regular;font-size: 12px;color: #C8CCD5;">单个文件最大支持100M，支持多个上传</span>
                        <a-table v-if="contractInfo.tradeContract" :pagination="false" :columns="editFilesColumns" :data-source="editTradeContractList"  :scroll="{x:true}" rowKey="path">
                            <template slot="type" slot-scope="type">
                                {{CONSTANTS.fileType[type]}}
                            </template>
                            <template slot="name" slot-scope="name,items">
                    ...
                    <!-- 贸易背景合同详情展示模块 -->
                    <template v-if="!editFlag">
                        <a-table v-if="contractInfo.tradeContract" :pagination="false" :columns="noFileName ? noFileNameFilesColumns:filesColumns" :data-source="filterLockFile(contractInfo.tradeContract.list)"  :scroll="{x:true}" rowKey="path">
                            <template slot="type" slot-scope="type">
                                {{CONSTANTS.fileType[type]}}
                            </template>
                            <template slot="name" slot-scope="name,items">
    ...
    export default({
        ...
        methods: {
            ...
            dealWithCommonData(data){
                ...
                pro.basePrice = data.downOnlineContract.basePrice
            ...
            getUploadFiles(data, type) { // 上传文件 获取附件数据
                ...
                if (type == 'TERMINAL_CONTRACT' || type == 'TERMINAL_CONTRACT_SUPPLEMENT' || type=='CONTRACT_OTHER_BID_PROOF') obj = this.contractInfo.downOnlineContract // 下游合同、下游合同补充文档
                    ...
                    if (obj) {
                        ...
                        if (i == this.fileInfos.length-1) {
                            ...
                            if (obj) {
                                ...
                                if (type == 'TERMINAL_CONTRACT' || type == 'TERMINAL_CONTRACT_SUPPLEMENT' || type=='CONTRACT_OTHER_BID_PROOF') this.contractInfo.downOnlineContract = project
            ...
            deleteFiles(items) { // 删除附件
                ...
                if (items.type == 'TERMINAL_CONTRACT' || items.type == 'TERMINAL_CONTRACT_SUPPLEMENT'|| items.type=='CONTRACT_OTHER_BID_PROOF'){// 下游合同、下游合同补充文档、中标佐证
