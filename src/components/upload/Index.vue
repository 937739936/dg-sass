...
import idcardImg from '../../assets/imgs/idcard.png';
import authLicenseImg from '../../assets/imgs/authLicenseImg.png';
import bizLicenseImg from '../../assets/imgs/bizLicenseImg.png';
...
export default {
	...
	created() {
		...
		if (this.value == 'bizLicenseImg') {
			...
			img = systemConfig.accountInfo.modifyApplyImgExample;
		}
		this.img = img;
	},
	watch: {
