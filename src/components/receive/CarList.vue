<template>
  <a-modal
    ...
    v-model="visible"
  >
    <a-form :form="form" v-bind="formLayout" :colon="false">
      <a-row>
        <a-col :span="8">
...
import { dispatchList } from "@/api/dispatch";
      ...
      return {
        ...
        onSelectAll: (selected, selectedRows, changeRows) => {
          if (selected) {
            ...
            itSelf.selectedRowKeys = [
              ...new Set([...tempArr, ...itSelf.selectedRowKeys]),
            ];
            itSelf.selectedRowData = [
              ...new Set([...selectedRows, ...itSelf.selectedRowData]),
            ];
          } else {
            // 待剔除
