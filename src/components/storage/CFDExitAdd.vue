  ...
  <div class="admission-add-cfd">
    <a-modal
      ...
      <a-form-model
        ...
        <a-form-model-item prop="outDate" label="出港时间">
          ...
          <a-row :gutter="24">
            <a-col :span="10">
              <a-form-model-item
                ...
                prop="stackNo"
                label="取出垛位号">
                <a-input v-model="row.stackNo" placeholder="请输入取出垛位号" />
                <!-- 修改时，只能修改已有数据，不能添加垛位号 -->
                <img v-if="!isEdit&&index===0&&list.length<5" class="operation-btn" @click="handleAddItem" :src="addIcon"/>
                <img v-if="!isEdit&&index!==0" class="operation-btn" @click="handleDeleteItem(index)" :src="deleteIcon"/>
              </a-form-model-item>
            </a-col>
            <a-col :span="6">
              <a-form-model-item
                ...
                prop="category"
                label="煤种">
                <a-input v-model="row.category" placeholder="请输入煤种" />
              </a-form-model-item>
            </a-col>
            <a-col :span="6">
              <a-form-model-item
                ...
                prop="weightTons"
                label="吨数">
                <a-input v-model="row.weightTons" placeholder="请输入吨数" />
              </a-form-model-item>
            </a-col>
          </a-row>
        </a-form-model>
...
export default {
  ...
  data () {
    return {
      title: '',
      addIcon: require('../../assets/imgs/storage/add.png'),
      deleteIcon: require('../../assets/imgs/storage/delete.png'),
      labelCol: { span: 4 },
      wrapperCol: { span: 12 },
