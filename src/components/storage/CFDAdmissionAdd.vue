  ...
  <div class="admission-add-cfd">
    <a-modal
      ...
      <a-form-model
        ...
        <a-form-model-item prop="inDate" label="进港时间">
          <a-date-picker v-model="form.inDate" format="YYYY-MM-DD" @change="handleDateChange" />
        </a-form-model-item>
        <a-form-model-item prop="stackNo" label="存放垛位号">
          <a-input v-model="form.stackNo" placeholder="请输入存放垛位号" />
        </a-form-model-item>
        ...
        <a-form-model-item
          ...
          prop="shipName"
          label="车次/船名">
          <a-input v-model="form.shipName" placeholder="请输入车次/船名" />
        </a-form-model-item>
        <a-form-model-item v-if="form.operateType == '3'" prop="firstTrainNo" label="首车号">
          <a-input v-model="form.firstTrainNo" placeholder="请输入首车号" />
        </a-form-model-item>
        <a-form-model-item v-if="form.operateType == '3'" prop="lastTrainNo" label="尾车号">
          <a-input v-model="form.lastTrainNo" placeholder="请输入尾车号" />
        </a-form-model-item>
        <a-form-model-item prop="category" label="煤种">
          <a-input v-model="form.category" placeholder="请输入煤种" />
        </a-form-model-item>
        <a-form-model-item prop="weightTons" label="吨数">
          <a-input v-model="form.weightTons" placeholder="请输入吨数" />
        </a-form-model-item>
