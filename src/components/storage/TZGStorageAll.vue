...
<template>
  <div class="storage-all-tzg">
    <a-table
      ...
      :pagination="false"
      :rowClassName="(record) => {if(record.rowType === 'in')return 'row-in-class'}">
...
import {API_getWarehouseHarborMyListTzInOut, API_getWarehouseHarborMyInOutExportXls} from 'api/storage'
