<template>
	...
	>
		...
		<div class="header-name-avatar header-name">
			...
			<img
				class="avatar"
				:src="VUEX_ST_PERSONALLINFO.picUrl ? VUEX_ST_PERSONALLINFO.picUrl : require('@/v2/assets/imgs/person/default-avatar.png')"
			/>
			<Login ref="login" />
...
import { API_COMPANYGETSWITCHCOMPANY, API_COMPANYUSERSWITCH, API_COMPANYUSERDELETELOGINHISTORY } from 'api/account';
