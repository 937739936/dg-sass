			...
			<div class="location-info-contain">
				<div class="location-info-item">
					...
					<div
						...
						v-if="detailInfo.stationVO && detailInfo.stationVO.name"
					>
						{{ detailInfo.stationVO.name || '' }}
					</div>
				</div>
				<div class="location-info-item">
					...
					<div
						class="location-info-des"
						v-if="detailInfo.stationVO && detailInfo.stationVO.electronicFenceRadius"
					>
						{{ detailInfo.stationVO.electronicFenceRadius || '' }}km
					</div>
				</div>
				<div class="location-info-item">
					...
					<div
						class="location-info-des"
						v-if="detailInfo.stationVO && detailInfo.stationVO.address"
					>
						{{ detailInfo.stationVO.address || '' }}
					</div>
				</div>
				<div class="location-info-item">
					<div class="location-info-title">巡库地址：</div>
					<div class="location-info-des">
...
export default {
	...
	methods: {
		...
		drawStatioEelectronicFences() {
			...
			let lon = stationVO.longitude;
			let lat = stationVO.latitude;
			let radius = stationVO.electronicFenceRadius;
			if (lon && lat && radius) {
		...
		// 巡库员位置
		drawInspectMarker() {
			let lon = this.detailInfo.supervisorLocationLongitude;
			let lat = this.detailInfo.supervisorLocationLatitude;
			let inspectAddress = this.detailInfo.supervisorLocationAddress ?? '';
			if (!lon || !lat) {
				return;
			}
			let fakeMarker = new AMap.Marker({
