...
//src/v2/center/logisticsPlatform/api
import { getRelOrderContractList } from '@/v2/center/logisticsPlatform/api/inout.js';
import { getStationDetail } from '@/v2/center/logisticsPlatform/api';
...
export default {
	...
	methods: {
		...
		getRelationOrderList(data) {
			...
			getRelOrderContractList(params)
				.then(res => {
					if (res.success) {
