...
import {
	API_FinancingAdvanceSignList,
	API_FinancingAdvanceSignSave,
	API_FinancingAdvanceGetSigList,
	API_CfcaFinAdvanceMAINAutoSignature,
...
export default {
	...
	mounted() {
		...
		this.getDetail();
		API_FinancingAdvanceSignList({ financingApplyId: this.financingApplyId }).then(res => {
	...
	methods: {
		...
		autoSignature() {
			...
			API_CfcaFinAdvanceMAINAutoSignature({ financingApplyId: this.financingApplyId })
				.then(res => {
					if (res.success) {
		...
		step1(obj) {
			return API_FinancingAdvanceGetSigList({
				financingApplyId: this.financingApplyId,
				cert: obj.cert
			});
		},
		step2() {
			return API_FinancingAdvanceSignSave({
				financingApplyId: this.financingApplyId
			});
		},
		downAll() {
