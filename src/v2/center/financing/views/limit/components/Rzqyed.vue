<template>
	<div>
		...
		<a-table
			:columns="data.creditType == 'FINANCING_COMPANY_QUOTA' ? columnsRz : columns"
			class="new-table"
			:scroll="{ x: true }"
...
const columns = [
	...
	{ title: '下属企业名称', dataIndex: 'companyName', customRender },
	{ title: '额度细分金额（元）', dataIndex: 'totalAmount', customRender },
	...
	{ title: '在途已用额度（元）', dataIndex: 'transitUsedAmount', customRender },
	{ title: '在途剩余额度（元）', dataIndex: 'transitAvailableAmount', customRender },
	{ title: '是否与集团共享额度', dataIndex: 'creditLineLevel', scopedSlots: { customRender: 'creditLineLevel' } },
