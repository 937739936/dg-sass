	...
	<div>
		...
		>
			<li>
				...
				<span>
					{{ detailInfo.subdivideCreditLineDesc || '否' }}
				</span>
			</li>
		</ul>
		<div
			v-if="detailInfo.subdivideCreditLine == 1"
			class="table-box"
		>
			<a-table
				:columns="columns"
...
const columns = [
	...
	{
		title: '实际剩余额度（元）',
		dataIndex: 'actualRemainingAmount',
		scopedSlots: { customRender: 'actualRemainingAmount' }
	},
	{
		title: '是否与集团共享额度',
		dataIndex: 'sharedCreditLine',
		scopedSlots: { customRender: 'sharedCreditLine' }
	},
	{
		title: '额度状态',
		dataIndex: 'status',
