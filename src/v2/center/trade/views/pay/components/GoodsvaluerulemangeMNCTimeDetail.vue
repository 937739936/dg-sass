<template>
	...
	>
		<div class="inner-content">
			<div
				class="title"
				style="margin-bottom: 10px; border: none; background: none"
			>
			...
			<div
				class="inner-content inner"
				v-if="calcData.weightType == 2"
			>
				<div
					class="title"
					style="margin-bottom: 10px"
				>
					<i class="title_icon"></i>加权结算批次
				</div>
			...
			<div
				class="inner-content inner"
				v-show="calcData.singleBatchInfoList && calcData.singleBatchInfoList.length"
			>
				<div
					class="title"
					style="margin-bottom: 10px"
				...
				<div style="margin-bottom: 20px">&nbsp;{{ calcData.weightType == 2 ? '单批次结算货物批次' : '结算批次收货数据' }}：</div>
				<a-table
					:columns="columnsDan"
					:scroll="{ x: true }"
