	...
	<div class="wrap-step3">
		<div class="step-tip">
			...
			<span
				...
				@click="close"
			></span>
			<p class="desc">点击“选择考核指标”，可以填写相应的指标信息。</p>
			<div class="btn-wrap-step2">
				<span class="page">3/5</span>
				<a-button
					type=""
					ghost
					class="btn btn-prev"
...
export default {
	methods: {
		close() {
			this.$emit('step', -1);
			try {
				const code = reportCode.contract['createList'].step3Closed;
...
.wrap-step3 {
	...
	.white-wrap {
		...
		background: #fff;
		border-radius: 10px;
		background-image: url('~@/v2/assets/imgs/guide/contract3.png');
