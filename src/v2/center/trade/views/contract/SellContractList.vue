						...
						<template slot="title">
							<div class="btn-box-menu">
								...
								>
									...
									/>
									<div>
										<p class="btn-box-menu-item-title">新增电子合同</p>
										<p class="btn-box-menu-item-tips">使用电子签章签署合同</p>
									</div>
									<img
										class="icon-right"
								...
								>
									...
									/>
									<div>
										<p class="btn-box-menu-item-title">新增线下合同</p>
										<p class="btn-box-menu-item-tips">补录线下已签署的合同</p>
									</div>
									<img
										class="icon-right"
										src="@/v2/assets/imgs/contract/right_arrow_icon.png"
						...
						<div class="btn-box-title">
							<div
								...
								v-if="
									...
									VUEX_ST_COMPANYSUER.roles.some(el =>
										['ADMIN', 'OPERATOR', 'OPERATOR_PAY_APPLY', 'OPERATOR_PAY_CONFIRM'].includes(el.code)
									)
								"
							>
								<img
...
<script>
import ContractOnLineList from '@/v2/center/trade/views/contract/online/List';
import ContractOffLineList from '@/v2/center/trade/views/contract/offline/List';
...
export default {
	...
	methods: {
		handelChange() {
			this.$router.push('/center/contract/sell/list?active=' + this.active);
		},
		// 新增销售合同
		addContract() {
		...
		addOnLine() {
			...
			this.$router.push({
				path: '/center/contract/sell/online/add/step1',
				query: {
					type: 'SELL',
					flag: 'add'
				}
