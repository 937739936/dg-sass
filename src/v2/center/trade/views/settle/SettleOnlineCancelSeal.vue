<template>
	<div class="slMain">
		...
		>
			<div class="modalBack">
				<div class="tip">确认后，作废流程将结束，原结算仍然生效。如需再次作废原结算单，则需要重新走流程。</div>
				<a-form :form="form">
					<a-form-item>
						<a-textarea
							:maxLength="200"
...
import {
	...
	API_POSTINVALIDseal,
	API_POSTINVALIDgetseal,
	API_DOWNLPREVIEWTE,
	API_GETINVALIDcancel
	...
	methods: {
		...
		sign() {
			let obj = {
				...
				moduleSealType: 6, //模块编码 6代表结算单作废
