 ...
 * */
import { API_GET_LINKORDER, API_INVOICES_LINK_ORDER } from '@/v2/center/trade/api/invoice';
import SplitInvoiceInfo from '@/v2/center/trade/components/invoice/SplitInvoiceInfo.vue';
