	...
	<div class="contentBox">
		...
		>
			...
			<template v-if="editFlag">
				...
				<template v-if="receivalVO.bankUscc === '91654004MACNA8B65D' && receivalVO.assetType === 'ACCOUNTS_RECEIVABLE_MODIFY'">
					<Upload
						:receivalVO="receivalVO"
						mode="excelHsb"
						v-if="accountInfo.accountingSeal != 1"
						@uploadFiles="getUploadFiles"
						type="PAYMENT_ACCOUNTING_TABLE_EXCEL"
						btnText="上传EXCEL版核算表"
					></Upload>
				</template>
				<template v-else>
