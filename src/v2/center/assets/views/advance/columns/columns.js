...
export const searchList = [
	{
		...
		addonBeforeTitle: '编号',
		type: 'input',
		placeholder: '请输入合同编号、预付账款流水号、付款流水号'
	},
	{
...
export const columns = [
	...
	{ title: '预付账款金额(元)', dataIndex: 'amount', key: 'amount', scopedSlots: { customRender: 'amount' }},
	{
		title: '拟融资金额(元)',
	...
	{ title: '预付账款类型', dataIndex: 'typeText', key: 'typeText' },
	{ title: '预付账款申请日期', dataIndex: 'requestTime', key: 'requestTime' },
	...
	{ title: '预付账款流水号', dataIndex: 'serialNo', key: 'serialNo' },
