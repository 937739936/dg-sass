		...
		<div class="titleInfoTitle">
			<a-space :size="12">
				<em
					...
					>付</em
				>
				<span>预付账款流水号：{{ detailData.receivalVO.serialNo }}</span>
				<div
				...
				>
					...
					<span
						...
						v-clipboard:copy="detailData.receivalVO.serialNo"
					>
						<CopyNow class="cur"></CopyNow>
					</span>
				</div>
				<span
					v-if="detailData.receivalVO.statusText"
					:class="`statusDes status-${detailData.receivalVO.status}`"
					>{{ detailData.receivalVO.statusText }}</span
				>
			</a-space>
		</div>
		<a-row class="supple-info">
			<div class="titleInfoItem">
				...
				<span class="omit">
					<a-tooltip>
						<template slot="title">
							{{ detailData.receivalVO.contractNo }}
						</template>
						<a
							@click="goContract"
							href="javascript:;"
			...
			<div class="titleInfoItem">
				...
				<span class="omit">
					<a-tooltip v-if="detailData.receivalVO.sellerName">
						<template slot="title">
							{{ detailData.receivalVO.sellerName }}
						</template>
						{{ detailData.receivalVO.sellerName }}
					</a-tooltip>
					<span v-else>-</span>
			...
			<div class="titleInfoItem">
				...
				<span class="omit">
					<a-tooltip v-if="detailData.receivalVO.buyerName">
						<template slot="title">
							{{ detailData.receivalVO.buyerName }}
						</template>
						{{ detailData.receivalVO.buyerName }}
					</a-tooltip>
					<span v-else>-</span>
			...
			<div class="titleInfoItem">
				...
				<span class="omit">
					<a-tooltip v-if="detailData.receivalVO.bankName">
						<template slot="title">
			...
			<div class="titleInfoItem">
				<span class="label">预付账款申请日期：</span>
				<span class="omit">
					<a-tooltip v-if="detailData.receivalVO.requestTime">
						<template slot="title">
							{{ detailData.receivalVO.requestTime }}
						</template>
						{{ detailData.receivalVO.requestTime }}
					</a-tooltip>
					<span v-else>-</span>
			...
			<div class="titleInfoItem">
				<span class="label">付款流水号：</span>
				<span class="omit">
					<a-tooltip v-if="detailData.receivalVO.paymentNo">
						<template slot="title">
							{{ detailData.receivalVO.paymentNo }}
						</template>
						<a
			...
			<div class="titleInfoItem">
				...
				<span class="omit">
					<div v-if="detailData.auditChainAndOperator">
						<a-tooltip
						...
						>
							...
							<i v-if="i < detailData.auditChainAndOperator.operatorInfo.length">、</i>
						</a-tooltip>
					</div>
					<span v-else>-</span>
				</span>
