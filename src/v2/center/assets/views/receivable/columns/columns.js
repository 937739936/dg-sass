...
export const searchList = [
	{
		...
		addonBeforeTitle: '编号',
		type: 'input',
		placeholder: '请输入合同编号、应收账款流水号、付款单号'
	},
	{
		decorator: ['buyerName'],
...
export const columns = [
	...
	{ title: '应收账款金额(元)', dataIndex: 'amount', key: 'amount', scopedSlots: { customRender: 'amount' } },
	...
	{ title: '应收账款流水号', dataIndex: 'serialNo', key: 'serialNo' },
