		...
		>
			...
			>
				...
				<a-descriptions-item label="上游合同货值">
					<a-tooltip>
						<template slot="title"> {{ convertCurrency(detailDataContractInfoUpContractAmount) }}</template>
						<span style="color: rgba(255, 128, 15, 1)">￥{{ detailDataContractInfoUpContractAmount | formatMoney }}</span>
					</a-tooltip>
				</a-descriptions-item>
			</a-descriptions>
		</div>
				...
				>
					<div style="min-height: 520px; display: flex; flex-direction: column; justify-content: space-between">
						...
						<invoice
							...
							ref="invo"
							:lineId="detailDataReceivalVO.lineId"
...
export default {
	...
	computed: {
		...
		detailDataContractInfoUpContractAmount() {
			return this.detailDataReceivalVO?.totalGoodsValue || 0;
		}
	},
	mounted() {
