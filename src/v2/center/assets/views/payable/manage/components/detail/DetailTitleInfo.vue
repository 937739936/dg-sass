	...
	<div>
		<div class="titleInfoTitle">
			<a-space :size="12">
				...
				<span>应付账款流水号：{{ detailDataReceivalVO.serialNo }}</span>
				<div
		...
		<a-row class="supple-info">
			...
			<div class="titleInfoItem">
				<span class="label">应付账款申请日期：</span>
				<span class="omit cur">
			...
			<div class="titleInfoItem">
				...
				<span class="omit">
					<a-tooltip v-if="detailDataReceivalVO.paymentNo">
						<template slot="title">
							{{ detailDataReceivalVO.paymentNo }}
						</template>
						<a
				...
				>
					...
					<span
						...
						v-clipboard:success="onCopy"
						v-clipboard:error="onError"
						v-clipboard:copy="detailDataReceivalVO.paymentNo"
					>
						<CopyNow class="cur"></CopyNow>
					</span>
				</div>
				...
				<span class="omit cur">
					<div v-if="detailData.auditChainAndOperator">
						...
						>
							...
							<i v-if="i + 1 < detailData.auditChainAndOperator.operatorInfo.length">、</i>
						</a-tooltip>
					</div>
					<span v-else>-</span>
				</span>
