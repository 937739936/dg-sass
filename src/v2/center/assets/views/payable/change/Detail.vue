		...
		>
			<div class="methods-wrap">
				...
				<a
					href="javascript:;"
					@click="
						$route.query.fc ? $router.push('/center/assets/confirmRights') : $router.push('/center/assets/payable/change/list')
					"
					>返回</a
				>
			</div>
...
import { API_GetAccountsDetail, API_AuditReceivableDownload } from '@/v2/center/assets/api/index.js';
