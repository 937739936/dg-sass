				...
				<a-row :gutter="40">
					<a-col span="4">
						...
						>
							...
							<div
								@click="tabChange(6)"
								v-if="detailData.receivalVO.type !== 'PROOF'"
							>
								<div class="tabs-text">
							...
							<div @click="tabChange(7)">
								<div class="tabs-text">
									...
									<div v-if="transType == 'TRAIN'">代发证明（火运）</div>
									<div v-if="transType == 'TRAIN'">委托结算函（火运）</div>
									<div>上游其他材料</div>
									<div>下游其他材料</div>
								</div>
							</div>
...
import { API_GetAccountsPoolDetail, API_AuditReceivablePoolDownload } from '@/v2/center/assets/api/index.js';
