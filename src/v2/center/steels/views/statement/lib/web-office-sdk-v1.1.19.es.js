...
var p,
	...
	m = function (e, n, t) {
		...
		if (!v) {
			...
			r.appendChild(v),
				(v.destroy = function () {
					v.parentNode.removeChild(v), (v = null), window.removeEventListener('resize', a), h && (h.disconnect(), (h = null));
				});
		}
		return v;
	};
		...
		return t(this, function (t) {
			switch (t.label) {
				...
				case 6:
					t.sent(), (t.label = 7);
				case 7:
					d && d.objId ? (d = { objId: d.objId }) : 'function' == typeof d && ((f = b()), (n[f] = d), (d = { callbackId: f })),
						(t.label = 8);
				case 8:
					(i[l] = d), (t.label = 9);
				case 9:
				...
				switch (t.label) {
					...
					case 2:
						return 'open.result' !== v
							? [3, 3]
							: (void 0 !== (null === (S = null == b ? void 0 : b.fileInfo) || void 0 === S ? void 0 : S.officeVersion) &&
									((a.mainVersion = b.fileInfo.officeVersion), console.log('WebOfficeSDK Main Version: V' + a.mainVersion)),
								i.emit(G.fileOpen, b),
								[3, 15]);
					case 3:
	...
	try {
		...
		return (
			(K = {
				...
				destroy: function () {
					j.destroy(), r.empty(), (K = null), (B = new Set()), (D = 0), document.removeEventListener('fullscreenchange', L), P();
				},
				save: function () {
					return n(this, void 0, void 0, function () {
						return t(this, function (e) {
