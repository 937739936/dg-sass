const columns = [
	...
	},
	{
		...
		scopedSlots: { customRender: 'canTakePieceQuantity' },
		width: 100
	},
	{
		title: '预提件数',
	...
	},
	{
		...
		key: 'canTakeQuantity',
		width: 120,
		customRender: (text, record) => (text || record.id == '合计' ? text : '/')
	},
	{
		title: '预提数量(吨)',
...
const relationPayment = [
	{
		title: '回款类型',
		key: 'fundType',
		dataIndex: 'fundType',
		scopedSlots: { customRender: 'fundType' }
	},
	{
		title: '回款金额',
	...
	},
	{
		...
		scopedSlots: { customRender: 'availableCollectionAmount' }
	},
	{
		title: '本次使用回款金额(元)',
		key: 'currentUseAmount',
		dataIndex: 'currentUseAmount',
		scopedSlots: { customRender: 'currentUseAmount' }
	},
	{
		title: '回款日期',
		key: 'collectionDate',
...
export { columns, columnsCar, relationPayment, columnsEnclosure, columnsPutApp, columnsPutNoApp, columnsOperation };
