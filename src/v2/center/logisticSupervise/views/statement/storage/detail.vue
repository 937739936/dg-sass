<template>
	<div class="slMain">
		...
		>
			...
			<ul class="grid-wrap">
				<li>
					...
					<span
						...
						> <a href="javascript:;">{{ contractForm.paperContractNo }}</a> </span
					>
				</li>
				<li>
				...
				<li>
					...
					<span>{{ contractForm.buyerName }}</span>
				</li>
				<li>
					<span class="label">仓储方</span>
					<span>{{ contractForm.sellerName }}</span>
				</li>
				<li style="width:66.66%">
					<span class="label" >仓库</span>
					<span>{{ contractForm.contractDynamicsFields.warehouseName }}</span>
				</li>
			</ul>
			...
			<!-- <AttachmentView :list='fileDataSource' @handlePreview='handlePreview' @download='download'></AttachmentView> -->
			<a-table
...
import { API_DOWNLPREVIEWTE, API_transport_settle_details } from '@/v2/center/logisticSupervise/api/settle';
