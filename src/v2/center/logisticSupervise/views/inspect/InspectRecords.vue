			...
			<div :class="'table-box ' + (pagination.total > 10 ? 'fixedBottom' : '')">
				<div class="actions-box">
					<a-button
						...
						:loading="downloading"
						v-auth="'logicDeliverMonitor:viewStoreManager:record:download'"
						>下载报告</a-button
					>
				</div>
				<a-table
					...
					>
						<a-space>
							<a
								...
								v-auth="'logicDeliverMonitor:viewStoreManager:record:detail'"
								>详情</a
							>
							<a
...
import { getInspectRecordsList, downloadInspectRecordsReport } from '@/v2/center/logisticsPlatform/api';
...
const columns = [
	...
	{ title: '操作', dataIndex: '操作', key: '操作', width: 100, scopedSlots: { customRender: 'action' }, fixed: 'right' }
];
export default {
	mixins: [ListMixin],
	components: {},
