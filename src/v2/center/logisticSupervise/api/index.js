...
//质检记录-列表
export const getTaskList = data => request(`${ENV.BASE_STATION_API}/api/station/inspection/task/page`, data, 'POST', 2);
//站台巡库记录-巡库详情（对应时间段）
export const getTaskDetail = data => request(`${ENV.BASE_STATION_API}/sys/station/inspection/task/detail`, data, 'GET');

// 企业站台库存统计
export const getStationInventoryStatistics = data =>
	request(`${ENV.BASE_STATION_API}/api/inventory/manager/sumInventoryByStationId`, data, 'GET');

//运输监管-质检记录列表
export const getQualityRecords = data =>
	request(`${ENV.BASE_STATION_API}/api/station/inspection/task/inspectionPage`, data, 'POST',2);

//运输监管-质检详情
export const getQualityDetail = data => 
	request(`${ENV.BASE_STATION_API}/api/station/inspection/task/inspectionDetail`, data, 'GET');