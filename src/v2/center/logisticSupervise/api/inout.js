...
export const getInOutStatistics = data =>
	request(`${ENV.BASE_STATION_API}/api/storage/manage/record/weight/statistics`, data, 'GET');
// 获取出入库详情
...
// 导出出入库
export const exportInOutList = data =>
	request(`${ENV.BASE_STATION_API}/api/storage/manage/record/page/excel`, data, 'GET', 2, 'blob');
...
export const getInOutDetailList = data =>
	request(`${ENV.BASE_STATION_API}/api/storage/manage/record/page/record/detail`, data, 'GET');
// 查询操作记录
export const getInOutLogList = data =>
	request(`${ENV.BASE_STATION_API}/api/storage/manage/record/list/operation/log`, data, 'GET');
// 新增出入库
export const addInOut = data => request(`${ENV.BASE_STATION_API}/api/storage/manage/record/add`, data, 'POST', 2);
// 导出出入库明细
// 导出出入库
export const exportInOutDetailList = data =>
	request(`${ENV.BASE_STATION_API}/api/storage/manage/record/page/record/detail/excel`, data, 'GET', 2, 'blob');
// 出入库附件下载
 ...
 * 汽运-出入库记录编辑
 */
export const automobileRecordEdit = data =>
	request(`${ENV.BASE_STATION_API}/api/storage/record/automobile/record/edit`, data, 'POST', 2);

// 根据仓库id获取仓库记录的品名-发运
export const getWarehouseRecord = data => request(`${ENV.BASE_API}/api/deliver/getGoodsNameList`, data, 'GET');
// 根据仓库id获取港口记录的名称-发运
export const getPortNameRecord = data => request(`${ENV.BASE_API}/api/deliver/getShipPorts`, data, 'GET');
