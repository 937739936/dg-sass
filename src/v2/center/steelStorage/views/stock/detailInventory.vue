	...
	>
		<a-card :bordered="false">
			<div style="display: flex; justify-content: space-between">
				<span class="slTitle">明细库存查询</span>
			</div>
...
import { getDetailPageList, detailExport } from '../../api/stock.js';

import { warehouseContractList } from '../../api/warehouse.js';
