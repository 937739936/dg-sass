...
const {
  ...
  SMOKELESS_COAL_003,
  INJECTION_COAL_003
} = CONSTANTS.contractTemplateDict;
// 采购订单仓押--动力煤012-仓押、焦煤004-仓押、焦炭008-仓押、兰炭002-仓押、无烟煤002-仓押、喷吹煤002-仓押
const BUY_PRESSURE_LIST = [STEAM_COAL_013, COKING_COAL_005, COKING_008, SEMI_COKE_002, INJECTION_COAL_002, SMOKELESS_COAL_002];

// 销售订单仓押--动力煤1004-仓押、焦煤动力煤1004-仓押、焦炭动力煤1004-仓押、兰炭动力煤1004-仓押、无烟煤动力煤1004-仓押、喷吹煤动力煤1004-仓押
const SELL_PRESSURE_LIST = [STEAM_COAL_1004, COKING_COAL_1004, COKING_1004, SEMI_COKE_1004, INJECTION_COAL_1004, SMOKELESS_COAL_1004];

// 销售订单代采--动力煤1003-代采、焦煤动力煤1003-代采、焦炭动力煤1003-代采、兰炭动力煤1003-代采、无烟煤动力煤1003-代采、喷吹煤动力煤1003-代采
const SELL_PURCHASE_LIST = [STEAM_COAL_1003, COKING_COAL_1003, COKING_1003, SEMI_COKE_1003, INJECTION_COAL_1003, SMOKELESS_COAL_1003];

// 
const COMMON_AGENT_LIST = [SMOKELESS_COAL_000, INJECTION_COAL_000, SEMI_COKE_003, SMOKELESS_COAL_003, INJECTION_COAL_003];

export function getBaseInfoData1(data, coalType, contractTemplate, isTransportMode = false, selectOther = {}) {
  var temp = [],
    Train = [], // 火运
    Automobile = [], // 汽运
    Ship = [], // 船运
  ...
  if(COMMON_AGENT_LIST.includes(contractTemplate)) {
    temp = [
      ...
      },
      {
        ...
        value: "transportMode",
        require: true,
        data: filterCodeByKey("transportModeDict" + contractTemplate),
      },
    ];
    Train = [
      {
  ...
  if (BUY_PRESSURE_LIST.includes(contractTemplate)) {
    ...
    temp = [
      ...
      },
      {
        ...
        value: "settleMode",
        require: true,
        data: filterCodeByKey("settleModeDict"),
      },
      {
        label: "交（提）货地点",
        type: "input",
      ...
      },
      {
        ...
        require: true,
        data: CONSTANTS.transportResponsibilityList,
      },
      {
        label: "请输入运输负责方",
        type: "input",
      ...
      },
      {
        ...
        require: true,
        data: filterCodeByKey("freightPayTypeDict"),
      },
    ];
    (Ship = [
      {
  ...
  if (contractTemplate == CONSTANTS.contractTemplateDict.STEAM_COAL_003) {
    // 动力煤003
    temp = [
      {
        label: "基准价格(元/吨)",
  ...
  if (
    contractTemplate == CONSTANTS.contractTemplateDict.STEAM_COAL_001 ||
    contractTemplate == CONSTANTS.contractTemplateDict.STEAM_COAL_011 ||
    contractTemplate == CONSTANTS.contractTemplateDict.STEAM_COAL_002 ||
    contractTemplate == CONSTANTS.contractTemplateDict.STEAM_COAL_012 ||
    contractTemplate == CONSTANTS.contractTemplateDict.STEAM_COAL_004
  ) {
  ...
  if (contractTemplate == CONSTANTS.contractTemplateDict.STEAM_COAL_005) {
    // 动力煤、005
    temp = [
      {
        label: "基准价格(元/吨)",
  ...
  if (
    contractTemplate == CONSTANTS.contractTemplateDict.SEMI_COKE_001 ||
    contractTemplate == CONSTANTS.contractTemplateDict.INJECTION_COAL_001 ||
    contractTemplate == CONSTANTS.contractTemplateDict.SMOKELESS_COAL_001 ||
    contractTemplate == CONSTANTS.contractTemplateDict.COKING_001 ||
    contractTemplate == CONSTANTS.contractTemplateDict.COKING_002 ||
    contractTemplate == CONSTANTS.contractTemplateDict.COKING_004 ||
    contractTemplate == CONSTANTS.contractTemplateDict.COKING_005
  ) {
  ...
  if (contractTemplate == CONSTANTS.contractTemplateDict.COKING_003 || contractTemplate == CONSTANTS.contractTemplateDict.COKING_006) {
    // 焦炭003、006
    temp = [
      {
        label: "基准价格(元/吨)",
  ...
  if (contractTemplate == CONSTANTS.contractTemplateDict.COKING_COAL_001 || contractTemplate == CONSTANTS.contractTemplateDict.COKING_COAL_003) {
    // 焦煤001、003
    temp = [
      {
        label: "基准价格(元/吨)",
    ...
    contractTemplate == CONSTANTS.contractTemplateDict.COKING_COAL_000 ||
    contractTemplate == CONSTANTS.contractTemplateDict.SEMI_COKE_000 ||
    contractTemplate == CONSTANTS.contractTemplateDict.COKING_000
  ) {
    temp = [
      {
        label: "基准价格(元/吨)",
  ...
  if (contractTemplate == CONSTANTS.contractTemplateDict.COKING_COAL_004) {
    // 焦煤004
    temp = [
      {
        label: "基准价格(元/吨)",
  ...
  if (contractTemplate == CONSTANTS.contractTemplateDict.STEAM_COAL_006) {
    // 动力煤006(和辉与铁投专用)
    temp = [
      {
        label: "基准价格(元/吨)",
  ...
  if (contractTemplate == CONSTANTS.contractTemplateDict.STEAM_COAL_007) {
    // 动力煤合同模板007(晋和与铁投专用)
    temp = [
      {
        label: "基准价格(元/吨)",
  ...
  if (contractTemplate == CONSTANTS.contractTemplateDict.COKING_007) {
    // 焦炭合同模板007(泰佳翔与铁投专用)
    temp = [
      {
        label: "基准价格(元/吨)",
  ...
  if (contractTemplate == CONSTANTS.contractTemplateDict.STEAM_COAL_008) {
    // 动力煤合同模板008
    temp = [
      {
        label: "基准价格(元/吨)",
  ...
  if (contractTemplate == CONSTANTS.contractTemplateDict.STEAM_COAL_009 || contractTemplate == CONSTANTS.contractTemplateDict.STEAM_COAL_010) {
    // 动力煤合同模板009 010
    temp = [
      {
        label: "基准价格(元/吨)",
  ...
  if (contractTemplate == CONSTANTS.contractTemplateDict.STEAM_COAL_1001) {
    // 动力煤合同模板1001(销售)
    temp = [
      {
        label: "基准价格(元/吨)",
  ...
  if (data == CONSTANTS.transportModeDict.TRAIN) {
    result = temp.concat(Train);
  } else if (data == CONSTANTS.transportModeDict.AUTOMOBILE) {
    result = temp.concat(Automobile);
  } else if (data == CONSTANTS.transportModeDict.SHIP) {
    result = temp.concat(Ship);
  } else if (data == CONSTANTS.transportModeDict.AUTOMOBILE_AND_TRAIN) {
    result = temp.concat(CarAndTrain);
  } else {
    result = temp;
  }
  if (isTransportMode) {
    const transportFormField = {
      [CONSTANTS.transportModeDict.TRAIN]: Train,
      [CONSTANTS.transportModeDict.AUTOMOBILE]: Automobile,
      [CONSTANTS.transportModeDict.SHIP]: Ship,
      [CONSTANTS.transportModeDict.AUTOMOBILE_AND_TRAIN]: CarAndTrain,
    };
    const otherFormField = temp;
    return { transportFormField: transportFormField[data], otherFormField };
  }

  // 动力煤004、005、焦炭004 005 006 去掉运费支付方式
  if (contractTemplate == CONSTANTS.contractTemplateDict.STEAM_COAL_004 ||
      contractTemplate == CONSTANTS.contractTemplateDict.STEAM_COAL_005 ||
      contractTemplate == CONSTANTS.contractTemplateDict.COKING_004 ||
      contractTemplate == CONSTANTS.contractTemplateDict.COKING_005||
      contractTemplate == CONSTANTS.contractTemplateDict.COKING_006
  ){
    result = result.filter(item=>{return item.type !=='yfzf'})
  }
  return result;
}
// 对应创建订单(底部)
export function getOtherInfoData1(contractTemplate) {
  var otherInfo = {
    qualityIndexHtmlStr: false, //基准质量指标 动力煤1001特有
    qualityExamineWayHtmlStr: true, //质量和数量验收标准及方法
    makePriceWayHtmlStr: true, //合同定价办法
    settleWayHtmlStr: true, //结算付款方式
    otherAppointHtmlStr: true, //其他约定
    commitmentHtmlStr: true, //承诺函信息
    goodsPayMethod: false, //贷款支付方式 COKING_007焦炭007才有
    downstreamSignHtmlStr: true, ////下游签约信息描述  downstreamSignCompanyName下游直接签约企业downstreamSignCompanyName shipTransportCompanyName运输公司 shipTransportProtocolNo运输协议编号
    //销售订单仓押独有-- 承诺函-第一条款 downstreamSignCompanyName上游直接签约企业
    contactform: true,
    huozhi: false, // 货值计算模块暂时隐藏不使用
    customHtmlStr: false, //动力煤000（其他类型）
    customCount: true,
  ...
  if (
    contractTemplate == CONSTANTS.contractTemplateDict.STEAM_COAL_003 ||
    contractTemplate == CONSTANTS.contractTemplateDict.COKING_003 ||
    contractTemplate == CONSTANTS.contractTemplateDict.COKING_006
  ) {
  ...
  if (contractTemplate == CONSTANTS.contractTemplateDict.COKING_COAL_003) {
    otherInfo.qualityExamineWayHtmlStr = false;
    otherInfo.contactform = false;
    otherInfo.otherAppointHtmlStr = false;
    otherInfo.commitmentHtmlStr = false;
  ...
  if (contractTemplate == CONSTANTS.contractTemplateDict.STEAM_COAL_006 || contractTemplate == CONSTANTS.contractTemplateDict.STEAM_COAL_007) {
  ...
  if (contractTemplate == CONSTANTS.contractTemplateDict.STEAM_COAL_009) {
    //动力煤合同模板009
    otherInfo.otherAppointHtmlStr = false;
    otherInfo.commitmentHtmlStr = false;
    otherInfo.downstreamSignHtmlStr = false;
  }
  if (contractTemplate == CONSTANTS.contractTemplateDict.STEAM_COAL_010) {
    //动力煤合同模板010
  ...
  if (contractTemplate == CONSTANTS.contractTemplateDict.STEAM_COAL_012) {
    //动力煤000（其他类型）012
    otherInfo.qualityExamineWayHtmlStr = false;
    otherInfo.makePriceWayHtmlStr = false;
    otherInfo.settleWayHtmlStr = false;
  ...
  if (contractTemplate == CONSTANTS.contractTemplateDict.STEAM_COAL_011) {
...
// 对应订单详情页
export function getBaseInfoData4(data, resultDetail) {
  var result = [];
...
export function getBaseInfoData8(coalType) {
  let result = [];
  if (coalType == CONSTANTS.coalTypeDict.STEAM_COAL) {
    result = [
      // {
  ...
  } else if (coalType == CONSTANTS.coalTypeDict.COKE) {
    result = [
      // {
      //   data: "",
      //   label: "合同基准灰分(%)",
  ...
  } else if (coalType == CONSTANTS.coalTypeDict.COKING_COAL) {
    result = [
      {
        data: "",
        label: "本次结算灰分(Ad)(≤)(%)",
  ...
  } else if (coalType == CONSTANTS.coalTypeDict.INJECTION_COAL) {
    // 喷吹煤
    result = [
      {
        data: "",
  ...
  } else if (coalType == CONSTANTS.coalTypeDict.SMOKELESS_COAL) {
    // 无烟煤
    result = [
      {
        data: "",
  ...
  } else if (coalType == CONSTANTS.coalTypeDict.SEMI_COKE) {
    // 兰炭
    result = [
      {
        data: "",
