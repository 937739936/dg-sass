<template>
  <div>
    <div class="lay-container lay-wrapper-normal" v-if="isShowHeader">
      <!-- 浏览器更新提示 -->
      <div class="browser-update-box" v-if="browserUpdateVisible">
        <a-row type="flex" justify="space-between">
          <a-col class="flex-box">
            <img src="@/v2/assets/imgs/common/alert_big_icon.png" alt="" style="width:48px;height: 48px;">
            <div class="flex-item">
          ...
          <a-col class="flex-box">
            <a-space :size="50">
              <div class="space-item">
                <img src="@/v2/assets/imgs/common/chorme_icon.png" alt="" style="width:22px;height: 22px;">
                <span @click="downChorme()">下载谷歌浏览器</span>
              </div>
              <img
                @click="closeBrowserUpdateBox()"
                src="@/v2/assets/imgs/common/close_modal_icon.png" style="width:14px;height: 14px;">
            </a-space>
          </a-col>
        </a-row>
      </div>
      <header-com v-on:changeTab="changeTab" v-if="headerMenu"></header-com>
      <div class="lay-wrapper"  ref="layWrapper" :style="{height: headerMenu ? 'calc(100vh - 64px)' : '100vh'}">
        <div class="lay-content">
          <template v-if="sideMenu">
            ...
            <div class="main-content" id="mainContent">
              ...
              >
                <div v-if="isShow" class="main-content-inner-content">
                  <transition name="router-fade" mode="out-in">
                    <div style="width: 100%; height: 100%" id='bodyScroll'>
          ...
          <template v-else>
            <div class="main-content-noside" id="mainContent">
              <div
                class="main-content-inner"
                :style="{
                  margin: headerMenu ? '' : '0',
    ...
    <div class="lay-container lay-container-invoice" v-else>
...
export default {
  data() {
    return {
      isShow: true,
      noSideMenu: ["/center/workbench/myToDoList", "/center/message/index", "/center/message/facilityDetail", "/center/message/riskControlDetail", "/center/message/riskControlCertDetail","/center/message/riskControlPriceDeclineDetail","/center/message/inventoryDetail"], //列表中页面不展示左侧菜单栏
  ...
  methods: {
    ...
    closeBrowserUpdateBox() { // 关闭浏览器版本更新提示
