...
$(function () {
    let mainDiv = echarts.init($('#main-img_NWes7-main')[0]);
    ...
    _get('/business/screen/topic2', function (result) {
        let c = { "legend": { "show": true, "textColor": "white" }, "xAxis": { "show": true, "splitLineShow": false, "labelColor": "white", "axisColor": "#0055bd", "labelFontSize": "12" }, "yAxis": { "show": true, "splitLineShow": true, "labelColor": "white", "labelFontSize": "12", "axisColor": "#0055bd", "unit_01": "万吨", "unit_02": "万元" }, "series": { "a": { "series_name": "合同量", "value": "1", "width": 16, "color": { "style": "double", "value": "#2846ff", "from": "#2e66f7", "to": "#3879ff", "angle": 0 } }, "b": { "series_name": "发运量", "value": "2", "width": 16, "color": { "style": "double", "value": "#ff05c4", "from": "#f6d32e", "to": "#fde66e", "angle": 0 } }, "c": { "series_name": "融资量", "value": "3", "lineWidth": 2.5, "color": "#40a9ff" } } }
        let a = result
